...
//        {
//            internal static int Age(int jumin)
//            {
...
//            internal static int Day(int jumin)
//            {
//                string a = Convert.ToString(jumin);
//                a= a.Substring(4, 2);
...
//            internal static int Month(int jumin)
//            {
//                string a = Convert.ToString(jumin);
//                a= a.Substring(2, 2);
//                return Convert.ToInt32(a);
...
//            internal static string Type(int jumin)
//            {
//                string a = Convert.ToString(jumin);
//                a= a.Substring(6, 1);
...
//            internal static int Year(int jumin)
//            {
//                string a = Convert.ToString(jumin);
//                a= a.Substring(0, 2);
//                int b = Convert.ToInt32(a);
